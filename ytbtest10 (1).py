...
class RssSpider():
    ...
    def getcontent(self,total):
        ...
        for li in ul.findAll('div',{'class':'yt-lockup-content'}):
            ...
            rss=PyRSS2Gen.RSSItem(title=title,link="https://www.youtube.com"+link,author=fromwhere,description = str(descrip)+img1+img2 ,)
            print(title,link,fromwhere,img1+img2+ str(descrip))
